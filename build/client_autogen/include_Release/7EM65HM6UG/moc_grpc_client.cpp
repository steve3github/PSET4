/****************************************************************************
** Meta object code from reading C++ file 'grpc_client.h'
**
...
#error "The header file 'grpc_client.h' doesn't include <QObject>."
...
void OCRClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->resultReady((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (OCRClient::*)(QString , QString )>(_a, &OCRClient::resultReady, 0))
            return;
    }
}
...
// SIGNAL 0
void OCRClient::resultReady(QString _t1, QString _t2)
{
